...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'JARA'); ?></title>
    <style>
...
<body>
    <?php if(auth()->guard()->check()): ?>
        <header class="navbar">
            <div class="nav-left">
                <a href="<?php echo e(route('home')); ?>" class="brand">JARA</a>
                <nav class="nav-links">
                    <a href="<?php echo e(route('home')); ?>">Beranda</a>
                    <a href="<?php echo e(route('dashboard')); ?>">Dashboard</a>
                    <a href="<?php echo e(route('tasks.index')); ?>">Tugas</a>
                    <a href="<?php echo e(route('task-lists.index')); ?>">Kategori</a>
                    <a href="<?php echo e(route('tasks.create')); ?>">+ Tambah Tugas</a>
            ...
            <div class="nav-right">
                <div class="user-info">
                    ...
                    <span class="role-badge <?php echo e(Auth::user()->role); ?>">
...
</html><?php /**PATH /home/taka/Praktikum4/PPK-Pertemuan2/resources/views/layouts/app.blade.php ENDPATH**/ ?>